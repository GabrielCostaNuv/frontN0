...
async function getLocalStream() {
  navigator.mediaDevices
    ...
    .then((stream) => {
      view.localStream = stream; // A
      view.localAudio.srcObject = stream; // B
      view.localAudio.autoplay = true; // C
    })
    .catch((err) => {
...
export default function RecordVoice({
  ...
  useEffect(() => {
    // Solicitar permissão para o microfone assim que o componente for montado
    getLocalStream()
